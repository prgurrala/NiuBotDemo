namespace MultiDialogsBot.Dialogs
{
    ...
    public class HotelsDialog : IDialog<object>
    {
        ...
        {
            await context.PostAsync("Welcome to the DoIT Service Helper!");
        ...
        private IForm<HotelsQuery> BuildHotelsForm()
        {
            ...
            {
                await context.PostAsync($"Thank you {state.Name}. Account ID : {state.AccountID} Your request will be processed soon. A redirect will be added from  {state.SourceURL} to {state.DestinationURL}");
            };

            return new FormBuilder<HotelsQuery>()
                .Message("DoIT will process your request soon....")
                .AddRemainingFields()
        ...
        {
            await context.PostAsync("Thank you using our Bot.");
